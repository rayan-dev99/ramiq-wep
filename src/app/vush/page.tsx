  ...
  return (
    <div className="relative w-full min-h-screen bg-white text-text-main overflow-x-hidden">
      ...
      <main className="relative z-10 w-full">
        ...
        <section
          id="vush-hero"
          className="relative pt-28 sm:pt-36 md:pt-[160px] pb-10 sm:pb-16 md:pb-[80px] min-h-[85vh] flex items-center justify-center bg-white z-10 overflow-hidden"
        >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 w-full">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
              ...
              >
                <span className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full text-xs font-semibold text-primary bg-accent/80 mb-4 sm:mb-6">
                  <span className="w-1.5 h-1.5 rounded-full bg-primary animate-pulse" />
                  ميزة RAMIQ VUSH العاجلة
                </span>

                <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-text-main leading-tight md:leading-snug max-w-[650px] mb-4 sm:mb-6">
                  هل تحتاج شرحًا عاجلاً؟ لا تضيع وقتك في البحث.. احجز معلمك الآن!
                </h1>
                <p className="text-sm sm:text-base md:text-lg text-text-sub max-w-[580px] leading-relaxed mb-6 sm:mb-10">
